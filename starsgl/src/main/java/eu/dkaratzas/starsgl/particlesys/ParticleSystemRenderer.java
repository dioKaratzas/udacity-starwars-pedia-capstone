package eu.dkaratzas.starsgl.particlesys;
...
import eu.dkaratzas.starsgl.R;
import eu.dkaratzas.starsgl.utils.gl.RawResourceReader;
import eu.dkaratzas.starsgl.utils.gl.ShaderHelper;
...
public class ParticleSystemRenderer implements GLSurfaceView.Renderer {
    ...
    public ParticleSystemRenderer(GLSurfaceView glSurfaceView, Context context) {
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eglConfig) {
        ...
        final String vertexShader = RawResourceReader.readTextFileFromRawResource(mContext, R.raw.star_vert);
        final String fragmentShader = RawResourceReader.readTextFileFromRawResource(mContext, R.raw.star_frag);
